...
def mock_redis():
    ...
    with patch("hookwise.tasks.redis_client") as mock_tasks_redis:
        with patch("hookwise.api.redis_client") as mock_api_redis:
            with patch("hookwise.metrics.redis_client") as mock_metrics_redis:
                with patch("hookwise.extensions.redis_client") as mock_ext_redis:
                    with patch("hookwise.commands.redis_client") as mock_cmd_redis:
