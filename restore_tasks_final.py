...
# Keep everything after the celery initialization
parts = original_content.split('celery = make_celery("hookwise")')
rest = parts[-1] if len(parts) > 1 else ""

# Also need to fix the check_webhook_timeouts imports if they were messed up
if 'from .extensions import db' not in rest:
    # This is tricky, let's just use a more robust way to fix the function
    pass
