...
class WebhookLog(Base):
    id = db.Column(db.String(36), primary_key=True, default=lambda: str(uuid.uuid4()))
    config_id = db.Column(db.String(64), db.ForeignKey("webhook_config.id", ondelete="CASCADE"), nullable=False, index=True)
    ...
    config = db.relationship("WebhookConfig", backref=db.backref("logs", lazy=True, cascade="all, delete-orphan", passive_deletes=True))
